...
const tech = [
  {
    name: "Next.js",
    icon: (
      <svg width="16" height="16" viewBox="0 0 180 180" fill="currentColor" aria-hidden="true">
        <mask id="nx" maskUnits="userSpaceOnUse" x="0" y="0" width="180" height="180" style={{ maskType: "alpha" as const }}>
  ...
  },
  {
    name: "TypeScript",
    icon: (
      <svg width="16" height="16" viewBox="0 0 400 400" fill="none" aria-hidden="true">
        <rect width="400" height="400" rx="50" fill="currentColor" fillOpacity="0.2" />
  ...
  },
  {
    name: "Supabase",
    icon: (
      <svg width="16" height="16" viewBox="0 0 109 113" fill="none" aria-hidden="true">
        <path d="M63.7 110.3C60.8 113.9 55.1 111.9 55 107.3L54 40.1H99.2c8.2 0 12.7 9.5 7.7 15.9L63.7 110.3Z" fill="currentColor" fillOpacity="0.8" />
        <path d="M45.3 2.1C48.2-1.5 54 .4 54.1 5L54.5 72.3H9.8C1.6 72.3-2.9 62.8 2.2 56.4L45.3 2.1Z" fill="currentColor" />
      </svg>
    ),
  },
  {
    name: "Stripe",
    icon: (
      <svg width="28" height="16" viewBox="0 0 60 25" fill="currentColor" aria-hidden="true">
  ...
  },
  {
    name: "Vercel",
    icon: (
      <svg width="16" height="14" viewBox="0 0 1155 1000" fill="currentColor" aria-hidden="true">
  ...
  },
  {
    name: "Resend",
    icon: (
      <svg width="16" height="16" viewBox="0 0 72 72" fill="none" aria-hidden="true">
        <rect width="72" height="72" rx="16" fill="currentColor" fillOpacity="0.15" />
...
export default function TechBar() {
  return (
    <section className="relative py-12 w-full" aria-label="Tech stack">
      {/* Hairline borders */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-x-0 gap-y-4"
        >
          {tech.map((t, i) => (
            <Fragment key={t.name}>
              {i > 0 && (
                <span
                  className="mx-5 text-zinc-800 select-none text-sm"
                  aria-hidden="true"
                >
                  ·
                </span>
              )}
              <div className="flex items-center gap-2 text-zinc-500 hover:text-zinc-300 transition-colors duration-200 cursor-default">
                {t.icon}
